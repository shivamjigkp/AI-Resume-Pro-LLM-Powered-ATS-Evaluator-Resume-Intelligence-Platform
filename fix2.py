...
corrupted_pattern_2 = re.compile(r"if \(data\.sheets && data\.sheets\.length > 0\) \{.*?\} catch \(e\) \{ console\.error\('Error fetching sheets for gate 2:', e\); \}", re.DOTALL)
...
html = corrupted_pattern_2.sub(fixed_code, html)
